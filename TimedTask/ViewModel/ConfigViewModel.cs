    ...
    public class ConfigViewModel : ViewModelBase
    {
        ...
        private void Save()
        {
            ...
            try
            {
                ...
                this._config.SetValue("MinToTray", TimedTask.Model.PM.MinToTray ? "1" : "0");
                this._config.Save();

                Helper.Instance.AlertSuccess("保存成功，重启后生效！");
            }
            catch (Exception ex)
            {
        ...
        {
            this._config = new ConfigHelper(TimedTask.Model.PM.Config);

...
namespace TimedTask
{
    public class Helper
    {
        ...
        private void ShowTip(TimedTask.Control.ShowTipType tipType, string msg)
        {
            Application.Current.Dispatcher.Invoke(new Action(() =>
               {
                   ...
                   switch (tipType)
                   {
                       ...
                       case TimedTask.Control.ShowTipType.Warning:
                           ...
                           break;
                       case TimedTask.Control.ShowTipType.Error: msg = (String.IsNullOrEmpty(msg) ? msg = msg = "操作失败！" : msg);
                           break;

...
namespace TimedTask
{
    ...
    public partial class App : Application
    {
        ...
        private void OnInit()
        {
            ...
            if (!System.IO.File.Exists(PM.StartPath + "\\Task.db"))
            {
                Helper.Instance.AlertWarning("数据库文件丢失！");
                Application.Current.Shutdown();
            }
            try
            {
            ...
            //MSL.Tool.Data.DbHelper.ConnectionString = string.Format(xml.GetValue( "Conn"), PM.StartPath + @"\");
